  ...
  private getSortedData(data: Product[]): Product[] {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort?.active) {
        ...
        //Nesta linha tivemos que colocar um "!" depois de 
        case 'id': return compare(+a.id!, +b.id!, isAsc);
        /* 
          OU podemos fazer assim:
        case 'id': return compare(a.id ? +a.id : 0, b.id ? +b.id : 0, isAsc);
        "Com isso vc esta falando.. caso venha valor diferente de undefined entao 
        transforme o valor em number. Caso venha undefined faça o valor ser 0"
        */ 
